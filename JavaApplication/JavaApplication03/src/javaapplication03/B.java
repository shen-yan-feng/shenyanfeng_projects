...
<text>
[{"t":"<#=@tjy#>统计月13个月当月继续率报表-个险","stl":{"sz":28}}]
</text>
</WidgetText>
</body>
</WidgetSheet>
...
select *
  from (select 机构.分公司 as fgs,
               ...
               sum(C_13个月.保单件数分母_13_M) as bdjsfm,
               sum(C_13个月.保单件数分子_13_M) as bdjsfz,
               sum(C_13个月.AP分母_13_M) as apfm,
               sum(C_13个月.AP分子_13_M) as apfz,
               max(统计区间.START_13) sxrq,
               max(统计区间.END_13) sxrz
          from DMART.CDM_DIM_CONTINUITY_MANAGECOM 机构,
               ...
               (select A.STARTDATE_ID        STATDATE,
                       ...
                       A.APBELOW_M           AP分母_13_M,
                       A.APUP_M              AP分子_13_M,
                       A.CONTCALCOUNTBELOW_M 保单件数分母_13_M,
                       A.CONTCALCOUNTUP_M    保单件数分子_13_M
