 ...
 */
@Embeddable
public class EncryptBdyzResponsePolPK implements Serializable {
    ...
    public EncryptBdyzResponsePolPK() {
    }

    public EncryptBdyzResponsePolPK(String batchno, String policyNo, String insuredNo, String polNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EncryptBdyzResponsePolPK)) {
            return false;
        }
        EncryptBdyzResponsePolPK other = (EncryptBdyzResponsePolPK) object;
    ...
    public String toString() {
        return "model.EncryptBdyzResponsePolPK[ batchno=" + batchno + ", policyNo=" + policyNo + ", insuredNo=" + insuredNo + ", polNo=" + polNo + " ]";
    }
