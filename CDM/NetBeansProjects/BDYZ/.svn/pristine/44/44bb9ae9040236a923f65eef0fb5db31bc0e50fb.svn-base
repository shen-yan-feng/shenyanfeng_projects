 ...
 */
@Embeddable
public class EncryptBdyzResponseInsuredPK implements Serializable {
    ...
    public EncryptBdyzResponseInsuredPK() {
    }

    public EncryptBdyzResponseInsuredPK(String batchno, String policyNo, String insuredNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EncryptBdyzResponseInsuredPK)) {
            return false;
        }
        EncryptBdyzResponseInsuredPK other = (EncryptBdyzResponseInsuredPK) object;
    ...
    public String toString() {
        return "model.EncryptBdyzResponseInsuredPK[ batchno=" + batchno + ", policyNo=" + policyNo + ", insuredNo=" + insuredNo + " ]";
    }
