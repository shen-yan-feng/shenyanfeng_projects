 ...
 */
@Embeddable
public class BdyzResponseInsuredPK implements Serializable {
    ...
    public BdyzResponseInsuredPK() {
    }

    public BdyzResponseInsuredPK(String batchno, String contNo, String insuredNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BdyzResponseInsuredPK)) {
            return false;
        }
        BdyzResponseInsuredPK other = (BdyzResponseInsuredPK) object;
    ...
    public String toString() {
        return "model.BdyzResponseInsuredPK[ batchno=" + batchno + ", contNo=" + contNo + ", insuredNo=" + insuredNo + " ]";
    }
