 ...
 */
@Embeddable
public class EncryptBdyzResponseAppntPK implements Serializable {
    ...
    public EncryptBdyzResponseAppntPK() {
    }

    public EncryptBdyzResponseAppntPK(String batchno, String policyNo, String appntNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EncryptBdyzResponseAppntPK)) {
            return false;
        }
        EncryptBdyzResponseAppntPK other = (EncryptBdyzResponseAppntPK) object;
    ...
    public String toString() {
        return "model.EncryptBdyzResponseAppntPK[ batchno=" + batchno + ", policyNo=" + policyNo + ", appntNo=" + appntNo + " ]";
    }
