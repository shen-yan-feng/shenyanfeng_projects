 ...
 */
@Embeddable
public class QueryBdyzResponsePolPK implements Serializable {
    ...
    public QueryBdyzResponsePolPK() {
    }

    public QueryBdyzResponsePolPK(String batchno, String policyNo, String insuredNo, String polNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QueryBdyzResponsePolPK)) {
            return false;
        }
        QueryBdyzResponsePolPK other = (QueryBdyzResponsePolPK) object;
    ...
    public String toString() {
        return "model.QueryBdyzResponsePolPK[ batchno=" + batchno + ", policyNo=" + policyNo + ", insuredNo=" + insuredNo + ", polNo=" + polNo + " ]";
    }
